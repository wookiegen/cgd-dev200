...
- **Canny F1 @2048 vs c2048** scores the 2048 output against the 2048 edge map c2048 (Canny of the PiD round trip of the real image, tolerance 1 px); the student round trip is its reference at 1.0. This is the native-condition setting in which a CGD variant may receive the 2048 map (`update.md` Section 7).
