...
ax.axvline(1.0, color="0.8", lw=0.6); ax.text(1.0, ax.get_ylim()[0], " released", fontsize=6, color="0.5", va="bottom")
ax.set_xlabel("control strength at generation (OminiControl condition scale)"); ax.set_ylabel("canny F1 (pixel space)")
